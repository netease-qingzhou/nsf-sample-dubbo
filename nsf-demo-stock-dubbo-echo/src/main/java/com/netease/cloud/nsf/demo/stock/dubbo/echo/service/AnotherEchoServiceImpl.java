...
public class AnotherEchoServiceImpl implements EchoService {
	...
	public String echo() {
		...
		return "greeting from dubbo B echo service " + ip + ":" + port;
	}
	...
	public String echoStrAndInt(String str, Integer num) {
		...
		return "B echo service  -- " + str + num + " from " + ip + ":" + port;
	}
	...
	public String echoStrAndInt1(String str, Integer num) {
		...
		return "B echo service  -- " + str + num + " from " + ip + ":" + port + " count:" + count;
	}
	...
	private String fallback(Throwable t){
		String ip = RpcContext.getContext().getLocalHost();
		int port = RpcContext.getContext().getLocalPort();
		return "fallback in dubbo B echo service " + ip + ":" + port;
	}
}
